...
| `tree_training_mode`        | `Literal`                                           | `"disabled"`          | Tree training mode. 'sparse' enables tree training with Flex Attention module (flex attention), 'dta' enables Dynamic Tree Attention (dynamic tree training), 'disabled' disables tree training. **Choices:** `disabled`, `sparse`, `dta`                                                                                                                                                                                                                                                   |
...
| `dta_depth`                 | integer                                             | `16384`               | Depth for Dynamic Tree Attention. Only effective when tree_training_mode='dta'.                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| `partition_mode`            | `Literal`                                           | `"seqlen"`            | Data-parallel trajectory partition strategy in distributed rollout. 'seqlen' balances by total sequence length; 'dta' balances by DTA DFS-order n_tree_tokens estimate. **Choices:** `seqlen`, `dta`                                                                                                                                                                                                                                                                                        |

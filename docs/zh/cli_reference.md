...
| `enable_dta`                | boolean                                             | `False`               | Enable Dynamic Tree Attention.                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `dta_depth`                 | integer                                             | `16384`               | Depth for Dynamic Tree Attention.                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `dta_block_size`            | integer                                             | `2048`                | Block size for Dynamic Tree Attention.                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
